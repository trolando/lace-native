...
# Run UTS (Unbalanced Tree Search); configs: T1, T1L, T1XL, T3L, etc.
cargo run --release -p lace-example-uts -- -w 4 T3L

# Run parallel tree traversal (method tasks with &self).
cargo run --release -p lace-example-tree -- -w 4 -d 24
